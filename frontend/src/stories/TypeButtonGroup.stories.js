...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'A group of buttons for selecting Pokemon types. Users can choose up to two types simultaneously from a predefined list.',
      },
    },
  },
};
...
export const WithCallback = () => (
  <TypeButtonGroup onTypeSelect={(type) => console.log(`Selected type: ${type}`)} />
);
